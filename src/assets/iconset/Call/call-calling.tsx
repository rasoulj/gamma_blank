...
export default function CallCallingIconSet(props: SvgProps) {
  const color =
  ...
  return (
    ...
    >
      ...
      >
        <G id="call-calling-3" data-name="call-calling">
          <Path
            id="Vector"
          ...
          <Path
            id="Vector-2"
            data-name="Vector"
            d="M3.5,3.5A3.965,3.965,0,0,0,2.33,1.23,3.416,3.416,0,0,0,0,0"
            transform="translate(187 193.5)"
            fill="none"
            stroke={getColor({ theme, color })}
            strokeLinecap="round"
