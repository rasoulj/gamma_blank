...
export default function CallIncomingIconSet(props: SvgProps) {
  const color =
  ...
  return (
    ...
    >
      <G
        id="call-incoming-2"
        data-name="call-incoming"
        transform="translate(-236 -188)"
      >
        <G id="call-incoming-3" data-name="call-incoming">
          <Path
            id="Vector"
