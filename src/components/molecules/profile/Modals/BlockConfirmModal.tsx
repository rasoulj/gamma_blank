...
import {Layer, Typography, print} from '~/components/elemental';
import {Button} from 'native-base';
import {useQueryClient} from 'react-query';
import {useCreateBlockUser} from '../hooks';
  ...
  return (
    <>
      <CustomActionSheet isVisible={isVisible} onClose={onClose}>
        <View
          data-id="123-456-789-block-user-layer"
          ...
          data-parent={`block-${item?.id}-user-drawer-kit`}>
          <Layer
            data-id="content-block-user-layer"
            data-name="Layer"
            style={{position: 'relative', marginLeft: 5, marginRight: 5}}
            data-parent="123-456-789-block-user-layer">
            <Typography
              style={{
                textAlign: 'center',
                fontSize: 15,
      ...
      <BlockSuccessModal
        ...
        isVisible={isVisibleSuccessMessage}
