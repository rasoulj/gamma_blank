...
import {useRemoveWishList} from '../../hook';
...
const DeleteConfirmModal = ({
  ...
  const {mutate: mutateRemoveWishList, isLoading} = useRemoveWishList();

  const removeWishList = () => {
    mutateRemoveWishList(
      {wishListId: item?.id},
      {
        onSuccess(data) {
          navigateWithName('WishList');
